...
local request = require("wowdoc.util.web.request")
local m = {}
...
local function get_api_cat_pages(catName, names)
	...
	local res = request:DownloadFilePost(export_url, m.OUTPUT_XML:format(catName), form, 60)
end
