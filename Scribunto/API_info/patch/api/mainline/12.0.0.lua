...
local GlobalAPI = {
	...
	"C_DamageMeter.GetCurrentCombatSession",
	"C_DamageMeter.GetCurrentCombatSessionSource",
	...
	"C_HousingCatalog.GetBasicDecorInfo",
	...
	"C_UnitAuras.GetAuraDurationRemainingByAuraInstanceID",
